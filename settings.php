...
<!-- BEGIN FORM CONTENTS -->
<fieldset>
	<legend>Configure Digital Sensor GPIO Path</legend>
	<input type="text" name="digital_path" value="<?php echo $moduleSettings['digital_path']; ?>">
	<legend>Configure Analog Sensor Data Path</legend>
	<input type="text" name="analog_path" value="<?php echo $moduleSettings['analog_path']; ?>">				  
...
<!-- *************************************************************************** -->
	...
	foreach($moduleSettings['digital'] as $cur_parent_array => $cur_child_array) { ?>
		<p class="sensorRowDigital">
			<span class="numDigital">
...
<!-- *************************************************************************** -->
	...
	foreach($moduleSettings['analog'] as $cur_parent_array => $cur_child_array) { ?>
		<p class="sensorRowAnalog">
			<span class="numAnalog">
			...
			<span>									
				<input 
					id="analogLabel<?php echo $idNumAnalog; ?>" type="text" name="analogLabel[]" placeholder="Analog Label" value="<?php echo $cur_child_array['label']; ?>" class="analogLabel" required>

				<select id="analogType<?php echo $idNumAnalog; ?>" name="analogType[]" class="analogType" required>
					<option>Select Type</option>
					<?php 
